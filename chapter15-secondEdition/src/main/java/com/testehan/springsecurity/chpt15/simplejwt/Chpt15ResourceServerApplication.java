package com.testehan.springsecurity.chpt15.simplejwt;
...
public class Chpt15ResourceServerApplication {

	public static void main(String[] args) {
		SpringApplication.run(Chpt15ResourceServerApplication.class, args);
	}
