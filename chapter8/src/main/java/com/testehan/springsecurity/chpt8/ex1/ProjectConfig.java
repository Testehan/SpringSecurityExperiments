...
//                .anyRequest().permitAll();  // permits all other requests even if user is not authenticated
//                .anyRequest().authenticated();  // permits all other requests only if user is authenticated
